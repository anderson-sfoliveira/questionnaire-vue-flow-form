        ...
        <div class="f-section-wrap">
          <p>
            ...
            <span class="f-section-text">
              Ótimo trabalho, a pesquisa foi concluída e nossa demonstração foi concluída. Você pode revisar suas respostas ou pressionar enviar.
            </span>
          </p>
          <p class="f-description">Nota: Nenhum dado será salvo e/ou enviado nesta demonstração.</p>
        </div>  
      </template>
    ...
    data() {
      return {
        ...
        questions: [
          new QuestionModel({
            id: 'first_name',
            tagline: 'Oi! Bem-vindo ao nosso questionário de demonstração 😊',
          ...
          new QuestionModel({
            id: 'email',
            tagline: "Prazer em conhecê-lo 👀, vamos continuar",
            title: 'Forneça um e-mail de exemplo.',
          ...
          new QuestionModel({
            id: 'phone',
            title: 'Indo bem! 👍 Vá em frente e tente com um número de telefone.',
          ...
          new QuestionModel({
            ...
            content: 'Você chegou ao intervalo de seção do nosso pequeno questionário de demonstração.',
            description: 'Nota: Para continuar explorando, basta pressionar enter ou usar o botão continuar.',
            type: QuestionType.SectionBreak
          }),
          new QuestionModel({
            id: 'icon_rate',
            tagline: "Obrigado por isso. Agora, vamos dar estrelas ⭐ como avaliação",
            title: 'Quantas estrelas você dá para o último filme que assistiu?',
          ...
          new QuestionModel({
            id: 'opinion_scale',
            title: 'Escolha um número para expressar sua opinião 👇',
            subtitle: 'Você também pode usar ⌨️ números para selecionar uma opção',
          ...
          new QuestionModel({
            ...
            content: 'Pressione enter ou use o botão continuar para a tela de envio final.',
            type: QuestionType.SectionBreak,
            jump: {
              _other: '_submit'
            }
